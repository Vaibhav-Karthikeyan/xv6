...
int main(int argc, char *argv[])
{
  ...
  if(argc <= 2){
  15:	83 39 02             	cmpl   $0x2,(%ecx)
{
  18:	8b 41 04             	mov    0x4(%ecx),%eax
  if(argc <= 2){
  1b:	7f 1d                	jg     3a <main+0x3a>
    char* filename = "default.txt";                                 
    if(argv[1])
  1d:	8b 40 04             	mov    0x4(%eax),%eax
    char* filename = "default.txt";                                 
  20:	ba 89 08 00 00       	mov    $0x889,%edx
  25:	85 c0                	test   %eax,%eax
  27:	0f 44 c2             	cmove  %edx,%eax
      filename = argv[1]; 
    edit(0,filename);                                                  
  2a:	83 ec 08             	sub    $0x8,%esp
  2d:	50                   	push   %eax
  2e:	6a 00                	push   $0x0
  30:	e8 0b 00 00 00       	call   40 <edit>
    exit();
  35:	e8 59 03 00 00       	call   393 <exit>
  }
  exit();
  3a:	e8 54 03 00 00       	call   393 <exit>
  3f:	90                   	nop
...
00000040 <edit>:
{
  ...
  48:	56                   	push   %esi
  49:	53                   	push   %ebx
  4a:	83 ec 14             	sub    $0x14,%esp
  4d:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  50:	8b 7d 08             	mov    0x8(%ebp),%edi
  if ((fp = open(filename, O_CREATE | O_RDWR)) < 0) 
  53:	68 02 02 00 00       	push   $0x202
  58:	53                   	push   %ebx
  59:	e8 75 03 00 00       	call   3d3 <open>
  5e:	83 c4 10             	add    $0x10,%esp
  61:	85 c0                	test   %eax,%eax
  63:	0f 88 aa 00 00 00    	js     113 <edit+0xd3>
  69:	89 c6                	mov    %eax,%esi
  memset (buf,'\0',sizeof(buf));
  6b:	83 ec 04             	sub    $0x4,%esp
  6e:	eb 16                	jmp    86 <edit+0x46>
    printf(fp, "%s", buf);
  70:	83 ec 04             	sub    $0x4,%esp
  73:	68 c0 0b 00 00       	push   $0xbc0
  78:	68 72 08 00 00       	push   $0x872
  7d:	56                   	push   %esi
  ...
  86:	6a 64                	push   $0x64
  88:	6a 00                	push   $0x0
  8a:	68 c0 0b 00 00       	push   $0xbc0
  8f:	e8 5c 01 00 00       	call   1f0 <memset>
  94:	83 c4 10             	add    $0x10,%esp
  while((n = read(fd, buf, sizeof(buf))) > 0)
  97:	83 ec 04             	sub    $0x4,%esp
  9a:	6a 64                	push   $0x64
  9c:	68 c0 0b 00 00       	push   $0xbc0
  a1:	57                   	push   %edi
  a2:	e8 04 03 00 00       	call   3ab <read>
  a7:	83 c4 10             	add    $0x10,%esp
  aa:	89 c3                	mov    %eax,%ebx
  ac:	85 c0                	test   %eax,%eax
  ae:	7e 38                	jle    e8 <edit+0xa8>
if (buf[0]=='e' && buf[1]=='x' && buf[2]=='i' && buf[3]=='t')
  b0:	80 3d c0 0b 00 00 65 	cmpb   $0x65,0xbc0
  b7:	75 b7                	jne    70 <edit+0x30>
  b9:	80 3d c1 0b 00 00 78 	cmpb   $0x78,0xbc1
  c0:	75 ae                	jne    70 <edit+0x30>
  c2:	80 3d c2 0b 00 00 69 	cmpb   $0x69,0xbc2
  c9:	75 a5                	jne    70 <edit+0x30>
  cb:	80 3d c3 0b 00 00 74 	cmpb   $0x74,0xbc3
  d2:	75 9c                	jne    70 <edit+0x30>
  close(fp);
  d4:	89 75 08             	mov    %esi,0x8(%ebp)
}
  ...
  dd:	5d                   	pop    %ebp
  close(fp);
  de:	e9 d8 02 00 00       	jmp    3bb <close>
  e3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  e7:	90                   	nop
  e8:	83 ec 0c             	sub    $0xc,%esp
  eb:	56                   	push   %esi
  ec:	e8 ca 02 00 00       	call   3bb <close>
  if(n < 0){
  f1:	83 c4 10             	add    $0x10,%esp
  f4:	85 db                	test   %ebx,%ebx
  f6:	75 08                	jne    100 <edit+0xc0>
}
 ...
 100:	50                   	push   %eax
 101:	50                   	push   %eax
 102:	68 75 08 00 00       	push   $0x875
 107:	6a 01                	push   $0x1
 109:	e8 f2 03 00 00       	call   500 <printf>
    exit();
 10e:	e8 80 02 00 00       	call   393 <exit>
    printf(1, "error %s\n", filename);            
 113:	52                   	push   %edx
 114:	53                   	push   %ebx
 115:	68 68 08 00 00       	push   $0x868
 11a:	6a 01                	push   $0x1
 11c:	e8 df 03 00 00       	call   500 <printf>
    exit();
 121:	e8 6d 02 00 00       	call   393 <exit>
