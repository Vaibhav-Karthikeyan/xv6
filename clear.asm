...
00000000 <main>:
   ...
   f:	89 e5                	mov    %esp,%ebp
  11:	53                   	push   %ebx
  12:	bb 37 00 00 00       	mov    $0x37,%ebx
  17:	51                   	push   %ecx
  18:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  1f:	90                   	nop
	printf(1,"\n");
  20:	83 ec 08             	sub    $0x8,%esp
  23:	68 b8 07 00 00       	push   $0x7b8
  28:	6a 01                	push   $0x1
  2a:	e8 21 04 00 00       	call   450 <printf>
	if(x=='x')
  2f:	83 c4 10             	add    $0x10,%esp
  32:	83 eb 01             	sub    $0x1,%ebx
  35:	75 e9                	jne    20 <main+0x20>
		clear('A');
		exit();
  37:	e8 a7 02 00 00       	call   2e3 <exit>
  3c:	66 90                	xchg   %ax,%ax
  3e:	66 90                	xchg   %ax,%ax
...
void clear(int x){
  ...
  4b:	8b 5d 08             	mov    0x8(%ebp),%ebx
	if(x=='x')
  4e:	83 fb 78             	cmp    $0x78,%ebx
  51:	74 1f                	je     72 <clear+0x32>
  ...
  5b:	83 c3 01             	add    $0x1,%ebx
	printf(1,"\n");
  5e:	68 b8 07 00 00       	push   $0x7b8
  63:	6a 01                	push   $0x1
  65:	e8 e6 03 00 00       	call   450 <printf>
	if(x=='x')
  6a:	83 c4 10             	add    $0x10,%esp
  6d:	83 fb 78             	cmp    $0x78,%ebx
  70:	75 e6                	jne    58 <clear+0x18>
	}
 ...
 3ac:	89 d1                	mov    %edx,%ecx
{
 ...
 3d9:	0f b6 92 c4 07 00 00 	movzbl 0x7c4(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	eb 1a                	jmp    5f0 <printf+0x1a0>
          s = "(null)";
 5d6:	bb ba 07 00 00       	mov    $0x7ba,%ebx
        while(*s != 0){
