  ...
  18:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  if(argc < 3){
  1e:	7f 13                	jg     33 <main+0x33>
    printf(1, "copy: read error\n");
  20:	50                   	push   %eax
  21:	50                   	push   %eax
  22:	68 5b 08 00 00       	push   $0x85b
  27:	6a 01                	push   $0x1
  29:	e8 c2 04 00 00       	call   4f0 <printf>
    exit();
  2e:	e8 50 03 00 00       	call   383 <exit>
  }
  ...
  3a:	e8 84 03 00 00       	call   3c3 <open>
  3f:	83 c4 10             	add    $0x10,%esp
  42:	89 c3                	mov    %eax,%ebx
  44:	85 c0                	test   %eax,%eax
  46:	78 36                	js     7e <main+0x7e>
  ...
  48:	51                   	push   %ecx
  49:	51                   	push   %ecx
  4a:	68 02 02 00 00       	push   $0x202
  4f:	ff 76 08             	pushl  0x8(%esi)
  52:	e8 6c 03 00 00       	call   3c3 <open>
  57:	83 c4 10             	add    $0x10,%esp
  5a:	89 c7                	mov    %eax,%edi
  5c:	85 c0                	test   %eax,%eax
  5e:	78 33                	js     93 <main+0x93>
  ...
  62:	57                   	push   %edi
  63:	53                   	push   %ebx
  64:	e8 47 00 00 00       	call   b0 <cat>
  close(fd1);
  69:	89 1c 24             	mov    %ebx,(%esp)
  6c:	e8 3a 03 00 00       	call   3ab <close>
  close(fd2);
  71:	89 3c 24             	mov    %edi,(%esp)
  74:	e8 32 03 00 00       	call   3ab <close>
  exit();
  79:	e8 05 03 00 00       	call   383 <exit>
    printf(1, "copy: cannot open %s\n", argv[1]);
  7e:	53                   	push   %ebx
  7f:	ff 76 04             	pushl  0x4(%esi)
  82:	68 6d 08 00 00       	push   $0x86d
  87:	6a 01                	push   $0x1
  89:	e8 62 04 00 00       	call   4f0 <printf>
    exit();
  8e:	e8 f0 02 00 00       	call   383 <exit>
    printf(1, "copy: error initializing file: %s\n", argv[2]);
  93:	52                   	push   %edx
  94:	ff 76 08             	pushl  0x8(%esi)
  97:	68 84 08 00 00       	push   $0x884
  9c:	6a 01                	push   $0x1
  9e:	e8 4d 04 00 00       	call   4f0 <printf>
    exit();
  a3:	e8 db 02 00 00       	call   383 <exit>
  a8:	66 90                	xchg   %ax,%ax
  aa:	66 90                	xchg   %ax,%ax
  ac:	66 90                	xchg   %ax,%ax
  ae:	66 90                	xchg   %ax,%ax
...
000000b0 <cat>:
{
  ...
  bb:	53                   	push   %ebx
  bc:	8b 5d 08             	mov    0x8(%ebp),%ebx
  while((n = read(fd1, buf, sizeof(buf))) > 0) {
  bf:	eb 1d                	jmp    de <cat+0x2e>
  c1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    printf(fd2, "%s", buf);
  c8:	83 ec 04             	sub    $0x4,%esp
  cb:	68 c0 0b 00 00       	push   $0xbc0
  d0:	68 58 08 00 00       	push   $0x858
  d5:	56                   	push   %esi
  d6:	e8 15 04 00 00       	call   4f0 <printf>
  db:	83 c4 10             	add    $0x10,%esp
  while((n = read(fd1, buf, sizeof(buf))) > 0) {
  de:	83 ec 04             	sub    $0x4,%esp
  e1:	68 00 02 00 00       	push   $0x200
  e6:	68 c0 0b 00 00       	push   $0xbc0
  eb:	53                   	push   %ebx
  ec:	e8 aa 02 00 00       	call   39b <read>
  f1:	83 c4 10             	add    $0x10,%esp
  f4:	85 c0                	test   %eax,%eax
  f6:	7f d0                	jg     c8 <cat+0x18>
  if(n < 0){
  f8:	75 07                	jne    101 <cat+0x51>
}
 ...
 101:	50                   	push   %eax
 102:	50                   	push   %eax
 103:	68 5b 08 00 00       	push   $0x85b
 108:	6a 01                	push   $0x1
 10a:	e8 e1 03 00 00       	call   4f0 <printf>
    exit();
 10f:	e8 6f 02 00 00       	call   383 <exit>
...
printf(int fd, const char *fmt, ...)
{
 ...
 674:	eb 1a                	jmp    690 <printf+0x1a0>
          s = "(null)";
 676:	bb a7 08 00 00       	mov    $0x8a7,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c5:	a1 a0 0b 00 00       	mov    0xba0,%eax
{
 ...
 6e6:	73 10                	jae    6f8 <free+0x38>
{
 ...
 711:	5b                   	pop    %ebx
  freep = p;
 712:	a3 a0 0b 00 00       	mov    %eax,0xba0
}
 717:	5e                   	pop    %esi
 718:	5f                   	pop    %edi
 719:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 75d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 760:	8b 3d a0 0b 00 00    	mov    0xba0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7a9:	8b 3d a0 0b 00 00    	mov    0xba0,%edi
 ...
 7d2:	e8 e9 fe ff ff       	call   6c0 <free>
  return freep;
 7d7:	a1 a0 0b 00 00       	mov    0xba0,%eax
 ...
 804:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 807:	a3 a0 0b 00 00       	mov    %eax,0xba0
}
 ...
 827:	0b 00 00 
    base.s.size = 0;
 82a:	bf a4 0b 00 00       	mov    $0xba4,%edi
    base.s.ptr = freep = prevp = &base;
 82f:	c7 05 a4 0b 00 00 a4 	movl   $0xba4,0xba4
 836:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 839:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 83b:	c7 05 a8 0b 00 00 00 	movl   $0x0,0xba8
 842:	00 00 00 
    if(p->s.size >= nunits){
